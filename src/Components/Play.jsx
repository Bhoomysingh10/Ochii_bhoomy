...
function Play() {
    ...
    return (
        <div className='eyes w-full h-screen overflow-hidden'>
            <div className='relative w-full h-full bg-cover bg-center bg-[url("public/gamebg.jpg")]'>
                <div className='absolute flex h-84 gap-10 top-1/2 left-1/2 -translate-x-[50%] -translate-y-[50%]'>
                    <div className='w-[15vw] flex items-center justify-center h-[15vw] rounded-full bg-zinc-100'>
                        <div className='w-2/3 h-2/3 relative items-center justify-center rounded-full bg-zinc-900'>
                            <div style={{ transform: `translate(-50%,-50%) rotate(${rotate}deg)` }} className='line w-full absolute h-10 top-1/2 left-1/2 -translate-x-[50%] -translate-y-[50%]'>
